...
/**
 * Compact label/pill used to surface status across the dashboard: invoice
 * payment status (Paid / Failed / Draft), subscription status, plan status,
 * and tags. Five built-in variants map to the canonical Flexprice palette;
 * `bgColor` / `textColor` / `borderColor` overrides are available for
 * one-offs. Becomes interactive (with hover + active-press) when `onClick`
 * is provided.
 */
